<%@ Page Title="" Language="C#" MasterPageFile="~/teacher/teacher.master" AutoEventWireup="true" CodeFile="tteacherdetails.aspx.cs" Inherits="teacher_tteacherdetails" %>
    ...
    <div class="container-fluid">
        <asp:Panel ID="plsearch" runat="server" BorderStyle="Ridge">
            <div class="row">
                ...
                <div class="col-md-2">
                    <asp:TextBox ID="tbteacherid" runat="server" Style="vertical-align: bottom" CssClass="form-control" placeholder="Teacher ID" ></asp:TextBox>
                </div>
                <div class="col-md-1">
                    <h4>OR</h4>
                </div>
        ...
        <asp:Panel ID="plteacherlist" runat="server" BorderStyle="Ridge" Visible="false">
            <div class="row">
                <div class="col-md-12">
                    <asp:GridView ID="gvteacherlist" runat="server" AutoGenerateColumns="False" Width="100%" HeaderStyle-Font-Size="Large" HeaderStyle-BackColor="#2E3C59" HeaderStyle-ForeColor="White" OnRowDataBound="gvstudentlist_RowDataBound" OnSelectedIndexChanged="gvstudentlist_SelectedIndexChanged">
                        <Columns>
                            ...
                            <asp:BoundField DataField="id1" HeaderText="Teacher ID" SortExpression="roll" />
                ...
                <div class="col-md-8" style="border-left-style: groove">
                    <form role="form">
                        ...
                        <div class="form-group">
                            <asp:Label ID="lbteacherid" Text="Teacher ID:-" runat="server" CssClass="col-md-3" Style="font-size: larger; color: black;"></asp:Label>
                            <asp:Label ID="lbteacheridshow" runat="server" CssClass="col-md-5" Style="font-size: x-large; color: red; font-style: normal"></asp:Label>
                        </div>
                        <br />
                        <br />
                        ...
                        <div class="form-group">
                            <asp:Label ID="Label17" Text="Designation:-" runat="server" CssClass="col-md-3" Style="font-size: larger; color: black;"></asp:Label>
                            <asp:Label ID="lbdesignation" runat="server" CssClass="col-md-5" Style="font-size: x-large; color: red; font-style: normal"></asp:Label>
                        </div>
