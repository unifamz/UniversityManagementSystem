<%@ Page Title="" Language="C#" MasterPageFile="~/teacher/teacher.master" AutoEventWireup="true" CodeFile="tdetails.aspx.cs" Inherits="teacher_tdetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-6">
                <asp:Button ID="btnteacher" runat="server"  Text="Teacher" CssClass="btn btn-danger" style="font-size:medium" Width="231px" OnClick="btnteacher_Click" />
            </div>
            <div class="col-md-6">
                <asp:Button ID="btnstudent" runat="server"  Text="Student" CssClass="btn btn-danger" style="font-size:medium" Width="235px" OnClick="btnstudent_Click" />
            </div>
        </div>
    </div>
    <div class="container-fluid">
        ...
        <asp:Panel ID="plstudentlist" runat="server" BorderStyle="Ridge" >
            <div class="row">
                <div class="col-md-12">
                    <asp:GridView ID="gvstudentlist" runat="server" AutoGenerateColumns="False" Width="100%" HeaderStyle-Font-Size="Large" HeaderStyle-BackColor="#2E3C59" HeaderStyle-ForeColor="White" >
                        <Columns>
