<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="astudent.aspx.cs" Inherits="admin_astudent" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container-fluid bg-success">
        ...
        <asp:Panel ID="plassignroll" runat="server" BorderStyle="Ridge" BorderColor="#e0dcdf">
            <div class="row">
                <div class="col-md-12">
                    <asp:Label ID="Label1" CssClass="label control-label" runat="server" Text="Assign Roll No." Style="text-align: center; font-size: larger; color: black; font-family: Arial; margin-left: 500px;" Font-Underline="true"></asp:Label>
                </div>
                <br />
                <br />
                <br />
                ...
                <div class="col-md-3">
                    <asp:Label ID="lbdepartment" runat="server" Text="Department:-" Style="font-size: large"></asp:Label>
                </div>
                <div class="col-md-9">
                    <asp:DropDownList ID="ddldepartment" runat="server" CssClass="form-control" AutoPostBack="true" required autofocus OnSelectedIndexChanged="ddldepartment_SelectedIndexChanged">
                ...
                <div class="col-md-3">
                    <asp:Label ID="lbcourse" runat="server" Text="Course:-" Style="font-size: large"></asp:Label>
                </div>
                <div class="col-md-9">
                    <asp:DropDownList ID="ddlcourse" runat="server" CssClass="form-control" AutoPostBack="true" required autofocus>
                ...
                <br /><br />
                <div class="col-md-3">
                    <asp:Label ID="lbroll" runat="server" Text="Roll No.:-" Style="font-size: large"></asp:Label>
                </div>
                <div class="col-md-9">
                    <asp:TextBox ID="tbroll" runat="server" CssClass="form-control" placeholder="Roll Number" required></asp:TextBox>
                </div>
                <br />
                <br />
                <div class="col-md-3">
                    <asp:Label ID="lbname" runat="server" Text="Student Name:-" Style="font-size: large"></asp:Label>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-7">
                    <asp:Button ID="btnassignroll" runat="server" Text="Assign" CssClass="btn btn-info" Height="61px" Width="195px" OnClick="btnassignroll_Click" />
                </div>
            </div>
        </asp:Panel>
    </div>
    ...
    <div class="container-fluid bg-info">
        <asp:Panel ID="plshowstudent" runat="server" BorderStyle="Groove">
            <div class="row">
                <div class="col-md-12">
                     <asp:Button ID="Button1" runat="server" Text="Show List" CssClass="btn btn-info" Height="61px" Width="195px" OnClick="Button1_Click" formnovalidate/>
                </div>
                <div class="col-md-12">
                    <asp:GridView ID="GridView1" runat="server" Visible="false" AutoGenerateColumns="False" Width="100%" HeaderStyle-Font-Size="Large" HeaderStyle-BackColor="#2E3C59" HeaderStyle-ForeColor="White" DataSourceID="SqlDataSource1">
                        <Columns>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:NetDomainConnectionString %>" SelectCommand="SELECT [roll], [name],  [email], [birthday], [phone], [sex], [department], [course], [address], [state], [city], [pincode] FROM [student]"></asp:SqlDataSource>
