...
public partial class warden_wstudentrecord : System.Web.UI.Page
{
    SqlConnection s;
        ...
        try
        {
            if (tbroll.Text.Trim() != string.Empty && tbname.Text.Trim() == string.Empty)
            {
                ...
                if (sdr.Read())
                {
                    ...
                    //imgphoto.ImageUrl = "fetchimage.ashx?imageid=" + Convert.ToInt64(tbroll.Text);
                }
                else
                {
