<%@ Page Title="" Language="C#" MasterPageFile="~/warden/warden.master" AutoEventWireup="true" CodeFile="wstudentrecord.aspx.cs" Inherits="warden_wstudentrecord" %>
    ...
    <div class="container-fluid">
        <asp:Panel ID="plsearch" runat="server" BorderStyle="Ridge">
            <div class="row">
                ...
                <div class="col-md-2">
                    <asp:TextBox ID="tbroll" runat="server" Style="vertical-align: bottom" CssClass="form-control" placeholder="Roll No" OnTextChanged="tbroll_TextChanged"></asp:TextBox>
                </div>
                <div class="col-md-1">
                    <h4>OR</h4>
                </div>
                ...
                <div class="col-md-2">
                    <asp:TextBox ID="tbname" runat="server" CssClass="form-control" placeholder="Name" OnTextChanged="tbname_TextChanged"></asp:TextBox>
                </div>
                <div class="col-md-2">
